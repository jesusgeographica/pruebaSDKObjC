...
/**
 * Returns the state of zoom gestures. Zoom gestures allow to use double click and dual click to zoom in/out of the map.<br>
 * @return True if zoom gestures are enabled. False otherwise.
 */
-(BOOL)isZoomGestures;
/**
 * Sets the zoom gestures flag. By default, zoom gestures are not enabled.<br>
